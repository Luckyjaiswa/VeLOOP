/**
 * VELoop Assistant Knowledge Base & Heuristic Engine
 * Adheres strictly to the identity, platform rules, and guardrails:
 * - Friendly, motivating, precise, and polite
 * - Hinglish / English auto-detection
 * - Short and crisp answers (max 2-3 sentences)
...
export const getLocalAssistantReply = (userMessage = '', userContext = {}) => {
